...
during projected gradient ascent. They return new tensors (do not modify input
in place); the caller is responsible for using `tensor.copy_()` or similar when
in-place semantics are desired.
